...
mysql_select_db($database_conex, $conex);
$query_carrera = sprintf("SELECT c.id id, c.nombre carrera, count(r.idcar) cantidad FROM registro r JOIN carrera c ON r.idcar=c.id WHERE c.idfac=%s GROUP BY r.idcar", GetSQLValueString($colname_carrera, "int"));
...
<title>Reportes Por Facultad</title>
<!-- InstanceEndEditable -->
...
<div id="contenedor">
  ...
  <div id="cuerpo">
    ...
    <div id="contenido">
      ...
      <h1><!-- InstanceBeginEditable name="Título" -->REPORTES POR FACULTAD<!-- InstanceEndEditable --></h1>
      <!-- InstanceBeginEditable name="Contenido" -->
      <form id="form1" name="form1" method="get" action="reportCarrera.php">
...
?>
            ...
            <td><input type="image" name="imageField" id="imageField" src="../../img/excel.png" /></td>
          </tr>
        </table>
      </form>
      <p>&nbsp;</p>
