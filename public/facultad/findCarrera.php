...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO carrera (nombre, idfac) VALUES (%s, %s)",
  ...
  $insertGoTo = "findCarrera.php?id=" . $_POST['idfac'] . "";
  /*if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_conex, $conex);
$query_carrera = sprintf("SELECT * FROM carrera WHERE idfac = %s ORDER BY nombre ASC", GetSQLValueString($colname_carrera, "int"));
...
<div id="contenedor">
  ...
  <div id="cuerpo">
    ...
    <div id="contenido">
      ...
      <h1><!-- InstanceBeginEditable name="Título" --><?php echo $row_facultad['nombre']; ?><!-- InstanceEndEditable --></h1>
      <!-- InstanceBeginEditable name="Contenido" -->
      <?php if ($totalRows_carrera > 0) { // Show if recordset not empty ?>
  <table border="0" align="center">
    ...
    <?php do { ?>
      <tr>
        <td><?php echo $row_carrera['nombre']; ?></td>
        <td><a href="updateCarrera.php?id=<?php echo $row_carrera['id']; ?>"><img src="../../img/edit.png" width="22" height="22" alt="Editar" /></a></td>
        <td><a href="deleteCarrera.php?id=<?php echo $row_carrera['id']; ?>"><img src="../../img/trash.png" width="22" height="22" alt="Borrar" /></a></td>
      </tr>
      <?php } while ($row_carrera = mysql_fetch_assoc($carrera)); ?>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
...
<form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>">
        <table border="0" align="center">
          <tr>
            ...
            <span class="textfieldRequiredMsg"><br />Se necesita un valor.</span></span></td>
            <td><button type="submit">GUARDAR</button></td>
          </tr>
        </table>
        <input name="idfac" type="hidden" id="idfac" value="<?php echo $row_facultad['id']; ?>" />
        <input type="hidden" name="MM_insert" value="form1" />
      </form>
      <p>&nbsp;</p>
      <script type="text/javascript">
<!--
var sprytextfield1 = new Spry.Widget.ValidationTextField("vnombre");
//-->
      </script>
