...
if (isset($_REQUEST['codigo'])) {
  $colname_registro = $_REQUEST['codigo'];
}
mysql_select_db($database_conex, $conex);
$query_registro = sprintf("SELECT id, codigo,  autor, titulo FROM registro WHERE codigo=%s", GetSQLValueString($colname_registro, "int"));
...
<title>Búsqueda por Código</title>
<!-- InstanceEndEditable -->
...
<div id="contenedor">
  ...
  <div id="cuerpo">
    ...
    <div id="contenido">
      ...
      <h1><!-- InstanceBeginEditable name="Título" -->BÚSQUEDA POR CÓDIGO<!-- InstanceEndEditable --></h1>
      <!-- InstanceBeginEditable name="Contenido" -->
      <form id="form1" name="form1" method="post" action="findCodigo.php">
        <table border="0" align="center">
          <tr>
            ...
            <td valign="top"><button type="submit" name="boton">BUSCAR</button></td>
          </tr>
        </table>
      </form>
