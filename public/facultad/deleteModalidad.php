...
if ((isset($_POST['id'])) && ($_POST['id'] != "")) {
  $deleteSQL = sprintf("DELETE FROM modalidad WHERE id=%s",
                       GetSQLValueString($_POST['id'], "int"));

  mysql_select_db($database_conex, $conex);
  $Result1 = mysql_query($deleteSQL, $conex) or die(mysql_error());

  $deleteGoTo = "modalidad.php";
...
$colname_modalidad = "-1";
if (isset($_GET['id'])) {
  $colname_modalidad = $_GET['id'];
}
mysql_select_db($database_conex, $conex);
$query_modalidad = sprintf("SELECT * FROM modalidad WHERE id=%s", GetSQLValueString($colname_modalidad, "int"));
...
<div id="contenedor">
  ...
  <div id="cuerpo">
    ...
    <div id="contenido">
      ...
      <h1><!-- InstanceBeginEditable name="Título" -->ELIMINAR MODALIDAD<!-- InstanceEndEditable --></h1>
      <!-- InstanceBeginEditable name="Contenido" -->
      <form id="form1" name="form1" method="post" action="deleteModalidad.php">
        ...
        <input name="id" type="hidden" id="id" value="<?php echo $row_modalidad['id']; ?>" />
      </form>
      <p>&nbsp;</p>
