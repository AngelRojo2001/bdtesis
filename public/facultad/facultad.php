...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO facultad (nombre) VALUES (%s)",
                       GetSQLValueString($_POST['nombre'], "text"));

  mysql_select_db($database_conex, $conex);
  $Result1 = mysql_query($insertSQL, $conex) or die(mysql_error());

  $insertGoTo = "facultad.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<div id="contenedor">
  ...
  <div id="cuerpo">
    ...
    <div id="contenido">
      ...
      <h1><!-- InstanceBeginEditable name="Título" -->FACULTAD<!-- InstanceEndEditable --></h1>
      <!-- InstanceBeginEditable name="Contenido" -->
      <?php if ($totalRows_facultad > 0) { // Show if recordset not empty ?>
  <table border="0" align="center">
    <?php do { ?>
      <tr>
        <td><?php echo $row_facultad['nombre']; ?></td>
        <td><a href="updateFacultad.php?id=<?php echo $row_facultad['id']; ?>"><img src="../../img/edit.png" width="22" height="22" alt="Editar" /></a></td>
        <td><a href="deleteFacultad.php?id=<?php echo $row_facultad['id']; ?>"><img src="../../img/trash.png" width="22" height="22" alt="Borrar" /></a></td>
      </tr>
        ...
        <table border="0" align="center">
          <tr>
            <td><span id="sprytextfield1">
              <input name="nombre" type="text" id="nombre" size="40" /><br />
            <span class="textfieldRequiredMsg">Se necesita un valor.</span></span></td>
            <td valign="top"><button type="submit">GUARDAR</button></td>
          </tr>
        </table>
