...
mysql_select_db($database_conex, $conex);
$query_Recordset1 = sprintf("SELECT * FROM facultad WHERE id=%s", GetSQLValueString($colname_Recordset1, "int"));
...
<div id="contenedor">
  ...
  <div id="cuerpo">
    ...
    <div id="contenido">
      ...
      <h1><!-- InstanceBeginEditable name="Título" -->ELIMINAR FACULTAD<!-- InstanceEndEditable --></h1>
      ...
      <form id="form1" name="form1" method="post" action="">
        ...
        <strong>
        <input name="idBorrar" type="hidden" id="idBorrar" value="<?php echo $row_Recordset1['id']; ?>" />
        </strong>
      </form>
      <p>&nbsp;</p>
