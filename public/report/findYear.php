...
<div id="contenedor">
  ...
  <div id="cuerpo">
    ...
    <div id="contenido">
      ...
      <h1><!-- InstanceBeginEditable name="Título" -->REPORTES POR AÑO<!-- InstanceEndEditable --></h1>
      <!-- InstanceBeginEditable name="Contenido" -->
      <form id="form1" name="form1" method="post" action="reportYear.php">
        <table border="0" align="center">
          <tr>
            <td valign="top">Año:</td>
            <td valign="top"><span id="sprytextfield1">
            <input type="text" name="anio" id="anio" /><br />
            <span class="textfieldRequiredMsg">Se necesita un valor.</span><span class="textfieldInvalidFormatMsg">Formato no válido.</span><span class="textfieldMinCharsMsg">No se cumple el número requerido.</span><span class="textfieldMaxCharsMsg">Se ha superado el número máximo.</span></span></td>
