...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE login SET usuario=%s, password=%s WHERE id=%s",
...
mysql_select_db($database_conex, $conex);
$query_login = sprintf("SELECT * FROM login WHERE usuario=%s", GetSQLValueString($colname_login, "text"));
...
<div id="contenedor">
  ...
  <div id="cuerpo">
    ...
    <div id="contenido">
      ...
      <h1><!-- InstanceBeginEditable name="Título" -->EDITAR PERFIL<!-- InstanceEndEditable --></h1>
      ...
      <form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>">
        <table border="0" align="center">
          ...
          <tr>
            <th align="right" scope="row">Verificar Password:</th>
            <td><span id="spryconfirm1">
              <input name="password2" type="password" id="password2" value="<?php echo $row_login['password']; ?>" /><br />
