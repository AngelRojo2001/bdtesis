...
if ((isset($_POST['idcar'])) && ($_POST['idcar'] != "")) {
  $deleteSQL = sprintf("DELETE FROM carrera WHERE id=%s",
                       GetSQLValueString($_POST['idcar'], "int"));

  mysql_select_db($database_conex, $conex);
  $Result1 = mysql_query($deleteSQL, $conex) or die(mysql_error());

  $deleteGoTo = "findCarrera.php?id=" . $_POST['idfac'] . "";
...
<div id="contenedor">
  ...
  <div id="cuerpo">
    ...
    <div id="contenido">
      ...
      <h1><!-- InstanceBeginEditable name="Título" -->ELIMINAR CARRERA<!-- InstanceEndEditable --></h1>
      ...
      <form id="form1" name="form1" method="post" action="">
        ...
        <input name="idfac" type="hidden" id="idfac" value="<?php echo $row_carrera['idfac']; ?>" />
      </form>
      <p>&nbsp;</p>
