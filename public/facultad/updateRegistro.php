      ...
      <form action="<?php echo $editFormAction; ?>" id="form1" name="form1" method="POST">
        <table border="0" align="center">
          ...
          <tr>
            ...
            <td><textarea name="autor" cols="40" rows="2" id="autor"><?php echo $row_editar['autor']; ?></textarea></td>
          </tr>
          <tr>
            <td align="right" valign="top"><strong>Título:</strong></td>
            <td><textarea name="titulo" cols="40" rows="2" id="titulo"><?php echo $row_editar['titulo']; ?></textarea></td>
          </tr>
          <tr>
