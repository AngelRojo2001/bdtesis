...
<div id="contenedor">
  ...
  <div id="cuerpo">
    ...
    <div id="contenido">
      ...
      <h1><!-- InstanceBeginEditable name="Título" -->Usuario - <?php echo $_SESSION['MM_Username']; ?><br />
        <br />
<br />
      REGISTRO DE TESIS<!-- InstanceEndEditable --></h1>
      <!-- InstanceBeginEditable name="Contenido" -->
      <p>La BIBLIOTECA CENTRAL cuenta con el registro de las tesis o proyectos dirigidos a los estudiantes de diferentes carreras y para su mayor facilidad el automatizado de los reportes.</p>
